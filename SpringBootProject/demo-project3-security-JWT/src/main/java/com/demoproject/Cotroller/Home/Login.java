...
import com.demoproject.DTO.LoginRequest;
...
public class Login {
    ...
    // any user Login by Email + Password
    // @PostMapping("/user_login")
    // public ResponseEntity<?> userLogin(@PathVariable String domain, @RequestBody LoginRequest loginRequest){
    //     try {

    //         String user = baseUserService.userLogin(domain, loginRequest.getEmail(), loginRequest.getPassword());
    //         // Authentication user = studentService.LoginStudent(domain, loginRequest.getEmail(), loginRequest.getPassword());
    ...
    public ResponseEntity<?> facultyLogin(@PathVariable String domain, @RequestBody LoginRequest loginRequest){
        try {
    ...
    public ResponseEntity<?> subAdminLogin(@PathVariable String domain, @RequestBody LoginRequest loginRequest){
        try {
    ...
    public ResponseEntity<?> domainAdminLogin(@PathVariable String domain, @RequestBody LoginRequest loginRequest ){
        try {
