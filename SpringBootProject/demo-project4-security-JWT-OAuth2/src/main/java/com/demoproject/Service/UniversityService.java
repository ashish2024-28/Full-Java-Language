...
public class UniversityService {
    ...
    //     if(universityName ==" "){
    //         System.out.println("innstitution :"+university.getInstitutionName());
    //         return university.getInstitutionName();
    //     }
    //     System.out.println("\ninstitution :"+university.getInstitutionName());
    //     return universityName ;
    // }

    public String getUniversityName(String domain) throws Exception {
        ...
        return Optional.ofNullable(university.getUniversityName())
        ...
        // // if (universityName == null || universityName.trim().isEmpty() ||  universityName.isBlank() ) {
        //     return university.getInstitutionName();
        // }
        // return universityName;
    }
