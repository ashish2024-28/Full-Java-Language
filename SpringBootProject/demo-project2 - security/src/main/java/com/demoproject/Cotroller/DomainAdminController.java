...
@PreAuthorize("""
        ...
        #domain == authentication.principal.domain
        """)
public class DomainAdminController {
    ...
    @GetMapping
    public String test(@PathVariable String domain) {
        return universityService.getUniversityName(domain) + "DOMAIN_ADMIN Access OK";
    }
...
// ********** (self) DomainAdmin operations **********
    ...
    // @GetMapping("get-dadmin")
    // public DomainAdmin getDomainAdmin(@PathVariable String domain){
