...
public class StudentService {
    ...
    public Student LoginStudent(String domain, String email, String password){
        Student studentLogin = repo.findByEmailAndDomain(email, domain).orElse(null);
    ...
    public Student saveOAuthStudent(Student s) {
    s.setPassword(null); // OAuth users have no password
    s.setLastLoginDateTime(LocalDateTime.now());
    return repo.save(s);
}
