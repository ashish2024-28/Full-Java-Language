...
public class SubAdminService {
    ...
    public SubAdmin LoginSubAdmin(String domain, SubAdmin loginsubAdmin){
        SubAdmin subAdminG = SArepo.findByEmailAndDomain(loginsubAdmin.getEmail(),domain);
        SubAdmin subAdminP = SArepo.findByEmailAndPassword(loginsubAdmin.getEmail(),loginsubAdmin.getPassword());
        if ((Objects.equals(subAdminG.getDomain(), subAdminP.getDomain()) && Objects.equals(subAdminG.getEmail(), subAdminP.getEmail()))&& Objects.equals(subAdminG.getPassword(), subAdminP.getPassword())) {

            subAdminG.setLastLoginDateTime(LocalDateTime.now());
            return SArepo.save(subAdminG);
